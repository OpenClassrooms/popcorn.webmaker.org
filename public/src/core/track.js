...
define( [ "localized", "./eventmanager", "./trackevent", "./views/track-view", "util/sanitizer", "util/time" ],
        function( Localized, EventManager, TrackEvent, TrackView, Sanitizer, TimeUtils ){
