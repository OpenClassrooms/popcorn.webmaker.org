...
module.exports.embedURL = function( user, id ) {
  ...
  return parsedURL.protocol + "//" + parsedURL.host + "/popcorn/" + this.generateIdString( id ) + "_";
};

module.exports.embedShellPath = function( user, id ) {
  //return "/" + user + "/popcorn/" + this.generateIdString( id );
  return "/popcorn/" + this.generateIdString( id );
};
...
module.exports.embedShellURL = function( user, id ) {
  ...
  return parsedURL.protocol + "//" + parsedURL.host + "/popcorn/" + this.generateIdString( id );
};
